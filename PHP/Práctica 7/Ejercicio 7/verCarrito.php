...
?> 
    ...
    <div align="center">
        <a href="prductos.php?<?php echo SID;?>"><button type="button">Continuar la selección de productos</button></a>&nbsp; 
        <a href="registraPago.php?<?php echo SID;?>&costo=<?php echo $suma; ?>"><button type="button">Finalizar compra</button></a> 
    </div> 
...
<?php }
    ...
    <p align="center"> 
        ...
        <a href="productos.php?<?php echo SID;?>"><button type="button">Continuar</button></a> 
    </p> 
<?php }?> 
</body> 
</html>